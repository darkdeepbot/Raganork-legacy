...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? '*MADE BY ☬𝕯𝖊𝖊𝖕𝖉𝖎𝖆☬*' : process.env.ALL_CAPTION,
    ...
    PLK: process.env.OWNER_NAME === undefined ? '☬𝕯𝖊𝖊𝖕𝖉𝖎𝖆☬' : process.env.OWNER_NAME,
    ...
    SLINK: process.env.IG === undefined ? 'instagram.com/kumarduttadeep' : process.env.IG,
    ...
    SOURAVKL11: process.env.STICKER_DATA === undefined ? 'ᴅᴀʀᴋ ᴅᴇᴇᴘ|ᴋᴇᴘʟᴀʀ' : process.env.STICKER_DATA,
    ANTI_FAKE: process.env.AUTO_FAKE === undefined ? 'ᴅᴇᴇᴘ' : process.env.AUTO_FAKE,
    ...
    TAGALL: process.env.TAG_HEADER === undefined ? '*DARK-DEEP-BOT*' : process.env.TAG_HEADER,
    SKV: process.env.V_HEADER === undefined ? '*DARK DEEP BOT*' : process.env.V_HEADER,
    SKDR: process.env.DURATION === undefined ? '99978509' : process.env.DURATION,
    HANDLERS: process.env.HANDLERS === undefined ? '^[.!;]' : process.env.HANDLERS,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    YAK: process.env.YAK === undefined ? '916291588399' : process.env.YAK,
    sourav_g_link: process.env.GROUP_LINK === undefined ? 'https://chat.whatsapp.com/EjGu5q7Gi0f6ml5IDejQ7W' : process.env.GROUP_LINK,
    BRANCH: 'master',
    HEROKU: {
        HEROKU: process.env.HEROKU === undefined ? false : convertToBool(process.env.HEROKU),
        API_KEY: process.env.HEROKU_API_KEY === undefined ? 'I AM DARK DEEP' : process.env.HEROKU_API_KEY,
        APP_NAME: process.env.HEROKU_APP_NAME === undefined ? 'DARK-DEEP-BOT' : process.env.HEROKU_APP_NAME
    },
